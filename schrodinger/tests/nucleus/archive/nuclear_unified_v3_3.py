...
def objective(theta: Dict[str, float], base: ModelParams):
    ...
    # Common-geometry split for diagnosis
    abar = 0.5*(a3H + a3He)
    split_common = energy_total(Geometry(3, abar, Z=2), P)[0] - energy_total(Geometry(3, abar, Z=1), P)[0]

    # Loss
    w = {"D": 0.01, "4He": 10.0, "3H": 1.0, "3He": 1.2, "split": 4.0, "split_common": 2.0}
    loss = 0.0
    ...
    loss += w["split_common"] * (split_common - SPLIT_EXP)**2
...
def optimize(base: ModelParams, max_iter: int = 100):
    theta = {
        "g2_01": base.g2[(0,1)],
        "g2_11": base.g2[(1,1)],
        "g2_00": base.g2[(0,0)],
